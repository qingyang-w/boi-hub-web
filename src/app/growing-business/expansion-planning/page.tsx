...
export default function ExpansionPlanningPage() {
  const topics = [
    'All',
    ...
    'Securing Funding for Expansion Projects',
    'Legal Implications of Business Expansion',
    'Growing Through Integration',
    'Technology Supporting Business Expansion',
    'Building an Effective Expansion Team',
  ]
